...
| 14 | [Round-2 Closures](ResearchOutput/NewMathematics/14_Round2_Closures.md) | the 6 round-2 hypotheses tested and closed (experiments 296-301) |
...
| 19 | [Round-5 Closures](ResearchOutput/NewMathematics/19_Round5_Closures.md) | the 4 round-5 structural-gap attacks closed (experiments 316-320) |
...
| 27 | [ArXiv Mining](ResearchOutput/NewMathematics/27_ArXiv_Mining.md) | fresh angles tested; the heat-kernel spectral free-witness |
...
| 32 | [The De-Quant Frontier, Closed](ResearchOutput/NewMathematics/32_Dequant_Frontier_Closed.md) | every de-quantization route collapses to barrier 4 (experiment 361) |
...
- `ResearchOutput/NewMathematics/` — the 32 papers + consolidated report

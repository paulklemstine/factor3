#!/usr/bin/env python3
"""EXP 483 HIGH-PHASE (round-41 #2). Seed 20260902. Adapted from exp482 clean protocol.
...
SEED = 20260902
OUTDIR = "/tmp/exp41_highphase"
os.makedirs(OUTDIR, exist_ok=True)
T0 = time.time()

RES = {"exp": 483, "codename": "HIGH-PHASE", "seed": SEED,
       "hypotheses": {
...
PHASE13 = [3, 5, 7, 11, 13]
PHASE_EXT = [p for p in PRIMES_ALL if 17 <= p <= 97]
